# Table S17: Correlation between number of gene mutation and gene expression in
# two stages across nine cancer types.
...
for (project in projects) {
  for (stage in stages) {
    dat <- openxlsx::read.xlsx(
      "~/storage/data/archive/muscle/supp_tables/mutation_cor/mutation_corr.tpm.xlsx",
